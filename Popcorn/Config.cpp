...
const AColor AsConfig::Advertisement_Purple(AsConfig::Purple_Color, 2 * AsConfig::Global_Scale);
const AColor AsConfig::Advertisement_Blue(0, 159, 159, AsConfig::Global_Scale);
