...
void Draw_Bounds(HDC hdc, RECT &paint_area);
	...
	HPEN Highlight_Pen, BG_Pen, Letter_Pen, Brick_Red_Pen, Brick_Blue_Pen, Platform_Circle_Pen, Platform_Inner_Pen, Border_Blue_Pen, Border_White_Pen;
	HBRUSH Brick_Red_Brush, BG_Brush, Brick_Blue_Brush, Platform_Circle_Brush, Platform_Inner_Brush, Border_Blue_Brush, Border_White_Brush;
